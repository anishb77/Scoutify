# Scoutify
Scoutify helps amateur football players understand their strengths, compare themselves to similar NFL athletes, and receive a data-driven roadmap for improvement. Built with Next.js, React, Tailwind CSS, etc. and a FastAPI backend.
The version history might look cursed but I promise we split up the work 😅
